                                    ...
                                    >                  <div className="flex items-center gap-3 mb-2">
                                        ...
                                        {summary.urlToImage && (
                                            <div className="mb-3 overflow-hidden rounded-xl shadow-lg">
                                                <img
                                                    src={summary.urlToImage}
                                                    alt={displayTitle || summary.topic}
                                            ...
                                            <div className="mb-3 overflow-hidden rounded-xl bg-gradient-to-br from-slate-700 to-slate-800 border border-slate-600 shadow-lg">
                                                <div className={`w-full flex items-center justify-center text-slate-400 transition-all duration-500 ${
                                                    isExpanded ? 'h-64' : 'h-40'
                                                        ...
                                                        <p className="text-xs text-slate-500 mt-1">{summary.topic.toUpperCase()}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        )}
                                    ...
                                    <div className="flex items-center gap-3 ml-4">                {/* Mark as Read Button */}
                                        {isAuthenticated && summary._id && (
                                            <motion.button
                                                ...
                                                whileTap={{ scale: 0.95 }}
                                                className={`p-2 rounded-full transition-colors ${readStatuses[index]
