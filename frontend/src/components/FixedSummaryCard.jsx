        ...
        >{/* Front of card */}
          ...
          >          {/* Topic Badge with enhanced styling */}
            ...
            {urlToImage && (
              <div className="mb-4 overflow-hidden rounded-xl">
                <img
                  src={urlToImage}
                  alt={displayTitle || topic}                  className={`w-full object-cover rounded-xl transition-all duration-500 ${
                    isFlipped 
            ...
            <div
              className={`text-slate-200 text-sm leading-relaxed mb-6 cursor-pointer hover:bg-slate-800/30 rounded-lg p-3 -m-3 transition-colors group ${isFlipping || isAnimating ? 'pointer-events-none opacity-70' : ''
                }`}
              style={{
                display: '-webkit-box',
                WebkitLineClamp: 7,
            ...
            <button
              ...
              className={`absolute bottom-4 right-4 flex items-center text-xs transition-colors ${isFlipping || isAnimating
          ...
          >{/* Header with icon */}
            ...
            <button
              onClick={handleFlip}
              disabled={isFlipping}
              className={`absolute bottom-4 right-4 flex items-center text-xs transition-colors ${isFlipping
